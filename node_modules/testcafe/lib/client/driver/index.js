    ...
    var Driver = /** @class */ (function (_super) {
        ...
        Driver.prototype._onNavigateToCommand = function (command) {
            ...
            if (this.options.nativeAutomation && isFileProtocol(command.url)) {
                var redirectOpts = {
                    createXHR: hammerhead__default.createNativeXHR,
                    openFileProtocolUrl: this.communicationUrls.openFileProtocolUrl,
                };
                testcafeCore.browser.redirectUsingCdp(command, redirectOpts);
            }
            else {
        ...
        Driver.prototype._onSetBreakpointCommand = function (_a) {
            var _this = this;
            var isTestError = _a.isTestError;
        ...
        Driver.prototype._checkStatus = function () {
            ...
            return testcafeCore.browser
                ...
                if (isSessionChange) {
                    ...
                    var redirectOpts = {
                        createXHR: hammerhead__default.createNativeXHR,
                        openFileProtocolUrl: _this.communicationUrls.openFileProtocolUrl,
                        nativeAutomation: _this.options.nativeAutomation,
                    };
                    testcafeCore.browser.redirect(command, redirectOpts);
                }
                else {
