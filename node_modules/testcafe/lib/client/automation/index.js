...
(function () {
    ...
    ***************************************************************************** */
    ...
    function mouseMoveStep(options, dateNow, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var isFirstStep, startPoint, endPoint, currPosition, lastPosition, startTime, progress;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        isFirstStep = true;
                        startPoint = AxisValues.create(options.startPoint);
                        endPoint = AxisValues.create(options.endPoint).round(Math.floor);
                        currPosition = AxisValues.create(options.startPoint).round(Math.floor);
                        lastPosition = AxisValues.create(options.startPoint);
                        startTime = dateNow();
                        _a.label = 1;
                    case 1:
                        if (!!currPosition.eql(endPoint)) return [3 /*break*/, 4];
                        ...
                        if (options.needMoveImmediately)
                            ...
                            progress = Math.min((dateNow() - startTime) / options.movingTime, 1);
                            currPosition = AxisValues.create(options.distance).mul(progress).add(startPoint).round(Math.floor);
                        }
                        if (!!currPosition.eql(lastPosition)) return [3 /*break*/, 3];
                        return [4 /*yield*/, callback(currPosition)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
    ...
    var MoveAutomation = /** @class */ (function () {
        function MoveAutomation(el, offset, moveOptions, win, cursor, nativeAutomationInput) {
            if (nativeAutomationInput === void 0) { nativeAutomationInput = null; }
        ...
        MoveAutomation.create = function (el, moveOptions, win, cursor, nativeAutomationInput) {
            if (nativeAutomationInput === void 0) { nativeAutomationInput = null; }
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, new MoveAutomation(element, offset, moveOptions, win, cursor, nativeAutomationInput)];
                    }
                });
            });
        };
        ...
        MoveAutomation.prototype._move = function (endPoint) {
            return __awaiter(this, void 0, hammerhead.Promise, function () {
                var startPoint, distance, movingTime, mouseMoveOptions, events_1;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            startPoint = this.cursor.getPosition();
                            distance = AxisValues.create(endPoint).sub(startPoint);
                            movingTime = Math.max(Math.max(Math.abs(distance.x), Math.abs(distance.y)) / this.cursorSpeed, this.minMovingTime);
                            mouseMoveOptions = {
                            ...
                            if (!this.nativeAutomationInput) return [3 /*break*/, 4];
                            events_1 = [];
                            return [4 /*yield*/, mouseMoveStep(mouseMoveOptions, hammerhead.nativeMethods.dateNow, function (currPosition) { return __awaiter(_this, void 0, void 0, function () {
                                    var moveEvent;
                                    var _a;
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0: return [4 /*yield*/, ((_a = this.nativeAutomationInput) === null || _a === void 0 ? void 0 : _a.createMouseMoveEvent(currPosition, this.modifiers))];
                                            case 1:
                                                moveEvent = _b.sent();
                                                events_1.push(moveEvent);
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, this.nativeAutomationInput.executeEventSequence(events_1)];
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, this.cursor.move(endPoint)];
                        case 3:
                            _a.sent();
                            return [3 /*break*/, 6];
                        case 4: return [4 /*yield*/, mouseMoveStep(mouseMoveOptions, hammerhead.nativeMethods.dateNow, function (currPosition) {
        ...
        MoveAutomation.prototype._moveToCurrentFrame = function (endPoint, nativeAutomationMove) {
            var _this = this;
        ...
        MoveAutomation.prototype.run = function () {
            ...
            return this._scroll()
                ...
                if (!boundary.contains(endPoint))
                    return void 0;
                return _this._moveToCurrentFrame(endPoint, !!_this.nativeAutomationInput)
    ...
    (function (EventType) {
        ...
        EventType[EventType["InsertText"] = 4] = "InsertText";
    })(EventType || (EventType = {}));
    ...
    var utils = hammerhead__default.utils, eventSandbox = hammerhead__default.eventSandbox, nativeMethods$7 = hammerhead__default.nativeMethods;
    var messageSandbox$1 = eventSandbox.message;
    var MOUSE_EVENT_OPTIONS = {
        clickCount: 1,
    };
    var CALCULATE_TOP_LEFT_POINT_REQUEST_CMD = 'native-automation|calculate-top-left-point|request';
    var CALCULATE_TOP_LEFT_POINT_RESPONSE_CMD = 'native-automation|calculate-top-left-point|response';
    function getLeftTopPoint(driverIframe) {
        var rect = driverIframe.getBoundingClientRect();
        var borders = getBordersWidthFloat(driverIframe);
        var paddings = getElementPaddingFloat(driverIframe);
        return {
    ...
    messageSandbox$1.on(messageSandbox$1.SERVICE_MSG_RECEIVED_EVENT, function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var iframeWin, _a, x, y, iframe, topLeftPoint, responseMsg;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!(e.message.cmd === CALCULATE_TOP_LEFT_POINT_REQUEST_CMD)) return [3 /*break*/, 2];
                    iframeWin = e.source;
                    return [4 /*yield*/, calculateIFrameTopLeftPoint()];
                case 1:
                    _a = _b.sent(), x = _a.x, y = _a.y;
                    iframe = findIframeByWindow(iframeWin);
                    topLeftPoint = getLeftTopPoint(iframe);
                    responseMsg = {
    ...
    function calculateIFrameTopLeftPoint() {
        return __awaiter(this, void 0, void 0, function () {
            var msg, topLeftPoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(window !== window.parent)) return [3 /*break*/, 2];
                        msg = {
                            cmd: CALCULATE_TOP_LEFT_POINT_REQUEST_CMD,
                        };
                        return [4 /*yield*/, sendRequestToFrame(msg, CALCULATE_TOP_LEFT_POINT_RESPONSE_CMD, window.parent)];
                    case 1:
                        topLeftPoint = (_a.sent()).topLeftPoint;
                        return [2 /*return*/, topLeftPoint];
                    case 2: return [2 /*return*/, { x: 0, y: 0 }];
                }
            });
        });
    }
    var CDPEventDescriptor = /** @class */ (function () {
        ...
        CDPEventDescriptor._isNonCharKeyModifier = function (modifiers) {
            var nonCharModifiers = [KeyModifierValues.ctrl, KeyModifierValues.alt, KeyModifierValues.meta];
            return nativeMethods$7.arrayIndexOf.call(nonCharModifiers, modifiers) > -1;
        };
        ...
        CDPEventDescriptor.createMouseEventOptions = function (type, options) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, x, y;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, calculateIFrameTopLeftPoint()];
                        case 1:
                            _a = _b.sent(), x = _a.x, y = _a.y;
                            return [2 /*return*/, utils.extend({
    ...
    var NativeAutomationInput = /** @class */ (function () {
        function NativeAutomationInput(dispatchEventFn) {
            this._dispatchEventFn = dispatchEventFn;
        }
        NativeAutomationInput.prototype.mouseDown = function (options) {
            return __awaiter(this, void 0, void 0, function () {
                var eventOptions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, CDPEventDescriptor.createMouseEventOptions('mousePressed', options)];
                        case 1:
                            eventOptions = _a.sent();
                            return [2 /*return*/, this._dispatchEventFn.single(EventType.Mouse, eventOptions)];
                    }
                });
            });
        };
        NativeAutomationInput.prototype.mouseUp = function (options) {
            return __awaiter(this, void 0, void 0, function () {
                var eventOptions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, CDPEventDescriptor.createMouseEventOptions('mouseReleased', options)];
                        case 1:
                            eventOptions = _a.sent();
                            return [2 /*return*/, this._dispatchEventFn.single(EventType.Mouse, eventOptions)];
                    }
        ...
        NativeAutomationInput.prototype.keyDown = function (options) {
        ...
        NativeAutomationInput.prototype.keyUp = function (options) {
            var eventOptions = CDPEventDescriptor.createKeyUpOptions(options);
            return this._dispatchEventFn.single(EventType.Keyboard, eventOptions);
        };
        NativeAutomationInput.prototype.executeEventSequence = function (eventSequence) {
            return this._dispatchEventFn.sequence(eventSequence);
        };
        NativeAutomationInput.prototype.executeInsertText = function (text) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this._dispatchEventFn.single(EventType.InsertText, { text: text })];
                });
            });
        };
        NativeAutomationInput.prototype.createMouseMoveEvent = function (currPosition, modifiers) {
            return __awaiter(this, void 0, void 0, function () {
                var options;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, CDPEventDescriptor.createMouseEventOptions('mouseMoved', {
                                options: __assign({ clientX: currPosition.x, clientY: currPosition.y, button: 'none' }, modifiers),
                            })];
                        case 1:
                            options = _a.sent();
                            return [2 /*return*/, {
    ...
    var VisibleElementAutomation = /** @class */ (function (_super) {
        ...
        function VisibleElementAutomation(element, offsetOptions, win, cursor, dispatchNativeAutomationEventFn) {
            var _this = _super.call(this) || this;
            ...
            _this.window = win;
            _this.cursor = cursor;
            _this.nativeAutomationInput = dispatchNativeAutomationEventFn ? new NativeAutomationInput(dispatchNativeAutomationEventFn) : null;
        ...
        VisibleElementAutomation.prototype.canUseNativeAutomationEventSimulator = function (element) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, MoveAutomation.create(this.element, moveOptions, this.window, this.cursor, this.nativeAutomationInput)];
                        case 1:
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!isElementFocusable && !isContentEditable) {
                            ...
                            curActiveElement = nativeMethods$8.documentActiveElementGetter.call(curDocument);
    ...
    var LabelElementClickCommand = /** @class */ (function (_super) {
        ...
        LabelElementClickCommand.prototype.run = function () {
            ...
            var ensureFocusRaised = function (e) {
                focusRaised = nativeMethods$9.eventTargetGetter.call(e) === _this.input;
            };
    ...
    var ClickAutomation = /** @class */ (function (_super) {
        ...
        function ClickAutomation(element, clickOptions, win, cursor, dispatchNativeAutomationEventFn) {
            var _this = _super.call(this, element, clickOptions, win, cursor, dispatchNativeAutomationEventFn) || this;
        ...
        ClickAutomation.prototype._mousedown = function (eventArgs) {
            if (this.canUseNativeAutomationEventSimulator(eventArgs.element))
                return this.nativeAutomationInput.mouseDown(eventArgs);
            return this.strategy.mousedown(eventArgs);
        };
        ClickAutomation.prototype._mouseup = function (element, eventArgs) {
            var _this = this;
            if (this.canUseNativeAutomationEventSimulator(eventArgs.element)) {
                return this.nativeAutomationInput.mouseUp(eventArgs)
    ...
    function onMoveToIframeRequest(e, dispatchNativeAutomationEventFn) {
        ...
        if (cursor.getActiveWindow(window) !== iframeWin) {
            var nativeAutomationInput = null;
            ...
            MoveAutomation.create(iframe, moveOptions, window, cursor, nativeAutomationInput)
                ...
                messageSandbox$3.sendServiceMsg(responseMsg, iframeWin);
            });
        }
        else
            messageSandbox$3.sendServiceMsg(responseMsg, iframeWin);
    ...
    function onMoveOutRequest(e) {
        ...
        if (!e.message.iframeUnderCursor) {
            ...
            messageSandbox$3.sendServiceMsg({ cmd: MOVE_RESPONSE_CMD$1 }, parentWin);
            return;
        }
        var cursorPosition = cursor.getPosition();
        ...
        MoveAutomation.create(document.documentElement, moveOptions, window, cursor)
            ...
            messageSandbox$3.sendServiceMsg(responseMsg, parentWin);
        });
    }
    // Setup cross-iframe interaction
    messageSandbox$3.on(messageSandbox$3.SERVICE_MSG_RECEIVED_EVENT, function (e) {
        if (e.message.cmd === MOVE_REQUEST_CMD$1) {
            if (e.source.parent === window) {
                ...
                hammerhead__default.on(hammerhead__default.EVENTS.beforeUnload, function () { return messageSandbox$3.sendServiceMsg({ cmd: MOVE_RESPONSE_CMD$1 }, e.source); });
                onMoveOutRequest(e);
            }
        }
    });
    ...
    var SelectChildClickAutomation = /** @class */ (function () {
        function SelectChildClickAutomation(element, clickOptions) {
            ...
            if (this.parentSelect) {
                ...
                var parent_1 = nativeMethods$a.nodeParentNodeGetter.call(this.element);
    ...
    function findDraggableElement(element) {
        ...
        while (parentNode) {
            if (parentNode.draggable)
                return parentNode;
            parentNode = nativeMethods$b.nodeParentNodeGetter.call(parentNode);
        }
        return null;
    }
            ...
            return getElementFromPoint$2(this.cursor.getPosition())
                ...
                if (draggable && featureDetection$3.hasDataTransfer && !_this.skipDefaultDragBehavior) {
                    ...
                    if (isLink || domUtils$6.isImgElement(_this.dragElement)) {
                        ...
                        var outerHTML = htmlUtils$1.cleanUpHtml(nativeMethods$b.elementOuterHTMLGetter.call(_this.dragElement));
    ...
    var HoverAutomation = /** @class */ (function (_super) {
        ...
        function HoverAutomation(element, hoverOptions, dispatchNativeAutomationEventFn) {
            return _super.call(this, element, hoverOptions, window, cursor, dispatchNativeAutomationEventFn) || this;
        }
    ...
    var eventSandbox$1 = hammerhead__default.sandbox.event;
    ...
    function _updateSelectionAfterDeletionContent(element, selection) {
        ...
        var startParent = nativeMethods$c.nodeParentNodeGetter.call(startNode);
    ...
    function _typeTextInElementNode(elementNode, text, offset) {
        ...
        var parent = nativeMethods$c.nodeParentNodeGetter.call(elementNode);
        if (domUtils$7.getTagName(elementNode) === 'br')
            parent.insertBefore(nodeForTyping, elementNode);
        else if (offset > 0) {
            var childNodes = nativeMethods$c.nodeChildNodesGetter.call(elementNode);
    ...
    function simulateTextInput(element, text) {
        ...
        if (browserUtils$8.isSafari) {
            ...
            eventSandbox$1.on(eventSandbox$1.EVENT_PREVENTED_EVENT, onSafariPreventTextInput);
        }
        ...
        if (browserUtils$8.isSafari) {
            ...
            eventSandbox$1.off(eventSandbox$1.EVENT_PREVENTED_EVENT, onSafariPreventTextInput);
        }
    ...
    function getDeepActiveElement(currentDocument) {
        ...
        if (activeElement && testCafeCore.domUtils.isIframeElement(activeElement) &&
            nativeMethods$d.contentDocumentGetter.call(activeElement)) {
            try {
                activeElementInIframe = getDeepActiveElement(nativeMethods$d.contentDocumentGetter.call(activeElement));
            }
    ...
    function activeElementHasNegativeTabIndex(doc) {
        var activeElement = nativeMethods$d.documentActiveElementGetter.call(doc);
    ...
    var KeyPressSimulator = /** @class */ (function () {
        ...
        KeyPressSimulator.prototype.up = function (modifiersState) {
            ...
            var emulateClick = !browserUtils$a.isSafari &&
    ...
    function getSimulatedKeyInfo(keyCombination) {
        ...
        return testCafeCore.arrayUtils.map(actualKeys, function (key, index) {
            var commands = getKeyCombinationCommands(keyCombination, index);
            return hammerhead.utils.extend({ key: key, commands: commands }, getKeyInfo(key, eventKeyProperties[index]));
        });
    }
    ...
    messageSandbox$4.on(messageSandbox$4.SERVICE_MSG_RECEIVED_EVENT, function (e) {
        if (e.message.cmd === PRESS_REQUEST_CMD) {
            hammerhead__default.on(hammerhead__default.EVENTS.beforeUnload, function () { return messageSandbox$4.sendServiceMsg({ cmd: PRESS_RESPONSE_CMD }, e.source); });
            var pressAutomation = new PressAutomation(e.message.keyCombinations, e.message.options);
            pressAutomation
                .run()
                .then(function () { return messageSandbox$4.sendServiceMsg({ cmd: PRESS_RESPONSE_CMD }, e.source); });
        }
    });
    var PressAutomation = /** @class */ (function () {
        function PressAutomation(keyCombinations, options, dispatchNativeAutomationEventFn) {
        ...
        PressAutomation.prototype.run = function () {
            ...
            if (!isIframeWindow(window) && activeElementIsIframe && nativeMethods$e.contentWindowGetter.call(activeElement)) {
                var msg = {
                    cmd: PRESS_REQUEST_CMD,
                    keyCombinations: this.keyCombinations,
                    options: this.options,
                };
                return testCafeCore.sendRequestToFrame(msg, PRESS_RESPONSE_CMD, nativeMethods$e.contentWindowGetter.call(activeElement));
            }
    ...
    var RClickAutomation = /** @class */ (function (_super) {
        ...
        RClickAutomation.prototype._focus = function (eventArgs) {
            ...
            // NOTE: IE doesn't perform focus if active element has been changed while executing mousedown
            var simulateFocus = !browserUtils$c.isIE || this.eventState.activeElementBeforeMouseDown === domUtils$9.getActiveElement();
            return focusAndSetSelection(elementForFocus, simulateFocus, this.caretPos)
    ...
    function scrollEditableElementByPoint(element, point) {
        ...
        if (isInputElement && (browserUtils$d.isFirefox || browserUtils$d.isIE && browserUtils$d.version > 10))
            return;
        var elementOffset = positionUtils$4.getOffsetPosition(element);
        var elementBorders = styleUtils$6.getBordersWidth(element);
    ...
    function excludeElementScroll(element, point) {
        ...
        if (isInputElement && isTextEditable &&
            (browserUtils$d.isFirefox || browserUtils$d.isIE && browserUtils$d.version > 10)) {
            return {
    ...
    var SelectBaseAutomation = /** @class */ (function (_super) {
        ...
        SelectBaseAutomation.prototype._mousedown = function () {
            ...
            return cursor
                ...
                // NOTE: In WebKit and IE, the mousedown event opens the select element's dropdown;
                // therefore, we should prevent mousedown and hide the dropdown (B236416).
                var needCloseSelectDropDown = (browserUtils$e.isWebKit || browserUtils$e.isIE) &&
    ...
    var TypeAutomation = /** @class */ (function () {
        function TypeAutomation(element, text, typeOptions, dispatchNativeAutomationEventFn) {
        ...
        TypeAutomation.prototype._canUseNativeAutomationInput = function () {
            if (!this.nativeAutomationInput)
                return false;
        ...
        TypeAutomation.prototype._keypress = function () {
            ...
            this.eventState.simulateTypeChar = browserUtils$f.isAndroid || eventSimulator$e.keypress(this.eventArgs.element, this.eventArgs.options);
        };
    ...
    var nativeMethods$f = hammerhead__default.nativeMethods;
    var evalIframeScript = hammerhead__default.EVENTS.evalIframeScript;
    nativeMethods$f.objectDefineProperty(window, '%testCafeAutomation%', { configurable: true, value: exports$1 });
    // eslint-disable-next-line no-undef
    hammerhead__default.on(evalIframeScript, function (e) { return initTestCafeAutomation(nativeMethods$f.contentWindowGetter.call(e.iframe), true); });
